...
function init3DHouseBackground() {
    ...
    const initialScale = isMobile ? 0.78 : 1.05;
    const initialPosX = isMobile ? 0 : 3.2;
    const initialPosY = isMobile ? 0.45 : 0;
    ...
    function updateCanvasDimensions() {
        ...
        const targetScale = mobileCheck ? 0.78 : 1.05;
    ...
    function animateLoop() {
        ...
        houseGroup.position.y = isMobileScreen 
            ? Math.sin(time * 1.1) * 0.15 + 0.45 + (scrollFraction * 0.8)
